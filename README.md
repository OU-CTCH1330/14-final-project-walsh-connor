...
| 4. You use *any* standard library feature | 2 points |
| 5. You designed and used a class | 2 points |
| 6. You split class design in header and implementations files | 2 points |
| 7. You use function overloading, for instance overloaded class constructor | 2 points |
| 8. You use private and public class members, class is designed with encapsulation in mind | 2 points |
| 9. You use class inheritance | 2 points |
| 10. You use pointers and/or pass-by-reference | 2 points | 
| 11. You provided app documentation in `Readme.md` file (doesn't need to be long, but please use markup) | 2 points |
| 12. You added class diagram to app documentation | 2 points | 
| 13. You recorded a demo showcasing the UI and included (accessible) link in documentation | 2 points |
| 14. Early bird: assignment is submitted by Thursday evening | 2 points |

- If you record demo, you can use [Panopto](https://www.panopto.com/) or [MS Streams](https://www.microsoft365.com) for screen capture. Using university email will help with these services, you'll have instant account with premium features. You can use other service if you prefer. Don't forget to provide access to my user/email (or make recording public, at your discretion).
...
If you decide to supply documentation, your markup can go here. You can use a separate `*.md` file if you like. 